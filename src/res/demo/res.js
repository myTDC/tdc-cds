	...
	design: {
		1: {
			...
			sectionData: {
				...
				media: {
					1: 'https://tubikstudio.com/wp-content/uploads/2019/06/readability-tips-in-user-experience-design.png',
				...
				content: {
					...
					3: [
						'Background: As well as it happens with printed books and newspapers, in digital interfaces the background color has a great effect on the ability to read and distinguish both interactive elements and content.',
